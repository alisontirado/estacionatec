...
class Usuarios(db.Model):
    ...
    foto_perfil = db.Column(db.String(255), default='placeholder.png')
    
    # Relationships - ELIMINAR la relación duplicada con Pagos
    vehiculos = db.relationship('Vehiculos', backref='propietario', lazy=True)
    # QUITAR esta línea: pagos = db.relationship('Pagos', backref='usuario', lazy=True)
...
class Pagos(db.Model):
    ...
    ruta_prueba_pago = db.Column(db.String(300))
    
    # ✅ SOLO UNA relación - esta es suficiente
